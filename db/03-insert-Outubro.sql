...
/* =========================
   SUELLEN (planos_contratados_id = 2)
...
-- AULAS_TREINOS_EXERCICIOS (SUELLEN)
...
(1001, 9, 1, 1, 10.00,  8, 4, 90, 'Controlar respiração na execução'),
...
(1005, 10, 5, 1, 10.00,  8, 4, 90, 'Controlar respiração na execução'),
...
(1009, 11,  9, 1, 10.00,  8, 4, 90, 'Controlar respiração na execução'),
...
(1013, 12, 13, 1, 10.00,  8, 4, 90, 'Controlar respiração na execução'),
...
(1018, 13, 18, 1, 1.00,  8, 4, 90, 'Manter core estável durante todo exercício'),
(1019, 13, 19, 2, 19.21, 10, 4, 60, 'Focar na contração durante fase concêntrica'),
...
(1023, 14, 23, 1, 1.00,  8, 4, 90, 'Pressionar escápulas contra o banco'),
(1024, 14, 24, 2, 19.22, 10, 4, 60, 'Manter cotovelos levemente flexionados'),
(1025, 14, 25, 3, 13.21, 12, 3, 60, 'Focar no equilíbrio durante execução'),
(1026, 14, 26, 4, 14.75,  8, 1, 90, 'Respirar de forma controlada'),
(1027, 14, 27, 5, 14.50, 10, 1, 90, 'Evitar compensações na lombar'),

(1028, 15, 28, 1, 1.00,  8, 4, 90, 'Concentrar na contração peitoral'),
(1029, 15, 29, 2, 19.23, 10, 4, 60, 'Manter postura neutra da coluna'),
(1030, 15, 30, 3, 13.22, 12, 3, 60, 'Controlar fase excêntrica do movimento'),
...
(1034, 16, 34, 1, 1.00,  8, 4, 90, 'Foco na amplitude completa do movimento'),
(1035, 16, 35, 2, 19.23, 10, 4, 60, 'Manter tensão constante no músculo'),
(1036, 16, 36, 3, 13.23, 12, 3, 60, 'Estabilizar joelho durante execução'),
...
(1042, 18, 42, 1, 13.50,  8, 4, 90, 'Estabilizar ombros durante exercício'),
...
(1046, 19, 46, 1, 13.50,  8, 4, 90, 'Contrair peitoral no ponto máximo'),
...
(1051, 20, 51, 2, 23.48, 10, 4, 60, 'Focar na contração do peitoral'),
...
(1055, 21, 2, 2, 23.49, 10, 4, 60, 'Movimento controlado e sem momentum'),
...
(1059, 22, 6, 2, 23.50, 10, 4, 60, 'Amplitude completa do movimento'),
...
(1063, 23, 10, 2, 23.51, 10, 4, 60, 'Manter tensão constante no peitoral'),
...
(1066, 24, 13, 1, 10.00,  8, 4, 90, 'Melhorar a postura ao executar o exercício'),
...
(1071, 25, 18, 1, 10.00,  8, 4, 90, 'Melhorar a postura ao executar o exercício'),
...
(1076, 26, 23, 1, 10.00,  8, 4, 90, 'Melhorar a postura ao executar o exercício'),
...
(1081, 27, 28, 1, 10.00,  8, 4, 90, 'Melhorar a postura ao executar o exercício'),
...
(1087, 28, 34, 1, 1.01,  8, 4, 90, 'Ir até o final da amplitude'),
(1088, 28, 35, 2, 19.25, 10, 4, 60, 'Nov S2: Crucifixo +10%'),
(1089, 28, 36, 3, 13.24, 12, 3, 60, 'Nov S2: Afundo +10%'),
(1090, 28, 37, 4, 14.00,  8, 1, 90, 'Nov S2: Abdominal +10%'),

(1091, 29, 38, 1, 1.03,  8, 4, 90, 'Ir até o final da amplitude'),
(1092, 29, 39, 2, 19.26, 10, 4, 60, 'Nov S2: Crucifixo +10%'),
(1093, 29, 40, 3, 13.25, 12, 3, 60, 'Nov S2: Afundo +10%'),
(1094, 29, 41, 4, 10.00,  8, 1, 90, 'Nov S2: Abdominal +10%'),

(1095, 30, 42, 1, 10.09,  8, 4, 90, 'Ir até o final da amplitude'),
(1096, 30, 43, 2, 7.50, 10, 4, 60, 'Mesmo padrão de aumento'),
(1097, 30, 44, 3, 10.00, 12, 3, 60, 'Melhorar a postura dos ombros ao executar o exercício'),
(1098, 30, 45, 4, 12.50,  8, 1, 90, 'Nov S2: Abdominal +10%'),

(1099, 31, 46, 1, 1.00,  8, 4, 90, 'Ir até o final da amplitude'),
(1100, 31, 47, 2, 1.00, 10, 4, 60, 'Mesmo padrão de aumento'),
(1101, 31, 48, 3, 1.00, 12, 3, 60, 'Melhorar a postura ao executar o exercício'),
(1102, 31, 49, 4, 1.00,  8, 1, 90, 'Treinar a respiração durante o exercício');

-- EXECUCOES_EXERCICIOS (SUELLEN)
...
(3001, 32, 1, 1, 10.00,  8, 4, 90, 'Manter core estável durante todo exercício'),
...
(3005, 33, 5, 1, 10.00,  8, 4, 90, 'Manter core estável durante todo exercício'),
...
(3009, 34,  9, 1, 10.00,  8, 4, 90, 'Manter core estável durante todo exercício'),
...
(3013, 35, 13, 1, 10.00,  8, 4, 90, 'Manter core estável durante todo exercício'),
...
(3018, 36, 18, 1, 1.00,  8, 4, 90, 'Manter core estável durante todo exercício'),
(3019, 36, 19, 2, 19.88, 10, 4, 60, 'Focar na contração durante fase concêntrica'),
(3020, 36, 20, 3, 13.32, 12, 3, 60, 'Alinhar joelho com ponta do pé'),
...
(3023, 37, 23, 1, 1.00,  8, 4, 90, 'Pressionar escápulas contra o banco'),
(3024, 37, 24, 2, 19.89, 10, 4, 60, 'Manter cotovelos levemente flexionados'),
(3025, 37, 25, 3, 13.33, 12, 3, 60, 'Focar no equilíbrio durante execução'),
(3026, 37, 26, 4, 14.75,  8, 1, 90, 'Respirar de forma controlada'),
(3027, 37, 27, 5, 14.50, 10, 1, 90, 'Evitar compensações na lombar'),

(3029, 38, 29, 2, 19.91, 10, 4, 60, 'Concentrar na contração peitoral'),
(3028, 38, 28, 1, 1.00,  8, 4, 90, 'Manter postura neutra da coluna'),
(3030, 38, 30, 3, 13.34, 12, 3, 60, 'Controlar fase excêntrica do movimento'),
...
(3034, 39, 34, 1, 1.00,  8, 4, 90, 'Foco na amplitude completa do movimento'),
(3035, 39, 35, 2, 19.92, 10, 4, 60, 'Manter tensão constante no músculo'),
(3036, 39, 36, 3, 13.35, 12, 3, 60, 'Estabilizar joelho durante execução'),
...
(3051, 43, 51, 2, 23.41, 10, 4, 60, 'Focar na contração do peitoral'),
...
(3055, 44, 2, 2, 23.42, 10, 4, 60, 'Movimento controlado e sem momentum'),
...
(3059, 45, 6, 2, 23.43, 10, 4, 60, 'Amplitude completa do movimento'),
...
(3063, 46, 10, 2, 23.44, 10, 4, 60, 'Manter tensão constante no peitoral'),
...
(3066, 47, 13, 1, 10.00,  8, 4, 90, 'Melhorar a postura ao executar o exercício'),
...
(3071, 48, 18, 1, 10.00,  8, 4, 90, 'Melhorar a postura ao executar o exercício'),
...
(3076, 49, 23, 1, 10.00,  8, 4, 90, 'Melhorar a postura ao executar o exercício'),
...
(3081, 50, 28, 1, 10.00,  8, 4, 90, 'Melhorar a postura ao executar o exercício'),
...
(3087, 51, 34, 1, 1.00,  8, 4, 90, 'Melhorar a postura ao executar o exercício'),
(3088, 51, 35, 2, 19.75, 10, 4, 60, 'Manter ritmo constante na execução'),
(3089, 51, 36, 3, 13.36, 12, 3, 60, 'Ir até a falha muscular controlada'),
(3090, 51, 37, 4, 14.00,  8, 1, 90, 'Executar movimento controlado'),

(3091, 52, 38, 1, 1.00,  8, 4, 90, 'Melhorar a postura ao executar o exercício'),
(3092, 52, 39, 2, 19.76, 10, 4, 60, 'Manter ritmo constante na execução'),
(3093, 52, 40, 3, 13.37, 12, 3, 60, 'Ir até a falha muscular controlada'),
(3094, 52, 41, 4, 10.00,  8, 1, 90, 'Executar movimento controlado'),

(3095, 53, 42, 1, 1.00,  8, 4, 90, 'Melhorar a postura ao executar o exercício'),
(3096, 53, 43, 2, 19.77, 10, 4, 60, 'Manter ritmo constante na execução'),
(3097, 53, 44, 3, 13.38, 12, 3, 60, 'Ir até a falha muscular controlada'),
(3098, 53, 45, 4, 11.00,  8, 1, 90, 'Executar movimento controlado'),

(3099, 54, 46, 1, 1.00,  8, 4, 90, 'Melhorar a postura ao executar o exercício'),
(3100, 54, 47, 2, 19.78, 10, 4, 60, 'Manter ritmo constante na execução'),
(3101, 54, 48, 3, 13.39, 12, 3, 60, 'Esteira final leve'),
(3102, 54, 49, 4, 11.51,  8, 1, 90, 'Executar movimento controlado');
...
(id, aulas_treinos_exercicios_id, carga_executada, repeticoes_executadas, series_executadas, descanso_executado, finalizado) VALUES
-- Aula 32 (3001..3004)
(4001, 3001, 10.00, 8, 4, 90, TRUE),
(4002, 3002, 18.00, 10, 4, 60, TRUE),
(4003, 3003, 12.00, 12, 3, 60, TRUE),
(4004, 3004, 08.50, 15, 1, 0, TRUE),

-- Aula 33
(4005, 3005, 10.50,  8, 4, 90, TRUE),
(4006, 3006, 18.00, 10, 4, 60, TRUE),
(4007, 3007, 12.00, 12, 3, 60, TRUE),
(4008, 3008, 12.00, 12, 3, 60, TRUE),

-- Aula 34
(4009, 3009, 10.75,  8, 4, 90, TRUE),
(4010, 3010, 18.00, 10, 4, 60, TRUE),
(4011, 3011, 12.00, 12, 3, 60, TRUE),
(4012, 3012, 10.00, 12, 3, 45, TRUE),

-- Aula 35
(4013, 3013, 11.00,  8, 4, 90, TRUE),
(4014, 3014, 18.00, 10, 4, 60, TRUE),
(4015, 3015, 12.00, 12, 3, 60, TRUE),
(4016, 3016, 12.00, 12, 3, 60, TRUE),
(4017, 3017, 15.01,  8, 4, 90, TRUE),

-- Aula 36 (semana2 +10%)
(4018, 3018, 25.00, 10, 4, 60, TRUE),
(4019, 3019, 13.40, 12, 3, 60, TRUE),
(4020, 3020, 12.50, 10, 3, 90, TRUE),
(4021, 3021, 15.02,  8, 4, 90, TRUE),
(4022, 3022, 17.50, 10, 4, 60, TRUE),

-- Aula 37
(4023, 3023, 15.41, 12, 3, 60, TRUE),
(4024, 3024, 12.50, 10, 3, 90, TRUE),
(4025, 3025, 15.03,  8, 4, 90, TRUE),
(4026, 3026, 15.00, 10, 4, 60, TRUE),
(4027, 3027, 13.42, 12, 3, 60, TRUE),

-- Aula 38
(4028, 3028, 20.00, 10, 3, 90, TRUE),
(4029, 3029, 15.00,  8, 4, 90, TRUE),
(4030, 3030, 8.50, 10, 4, 60, TRUE),
(4031, 3031, 13.43, 12, 3, 60, TRUE),
(4032, 3032,  12.50, 10, 3, 90, TRUE),
(4033, 3033, 15.00,  8, 4, 90, TRUE),

-- Aula 39
(4034, 3034, 19.60,10, 4, 60, TRUE),
(4035, 3035, 14.40,12, 3, 60, TRUE),
(4036, 3036, 12.50, 12, 1, 90, TRUE),
(4037, 3037, 15.50, 8, 4, 90, TRUE),

-- Aula 40 (semana3 +20%)
(4038, 3038, 21.60, 10, 4, 60, TRUE),
(4039, 3039, 14.40, 12, 3, 60, TRUE),
(4040, 3040,  7.50, 12, 1, 90, TRUE),
(4041, 3041, 7.00,  8, 4, 90, TRUE),

-- Aula 41
(4042, 3042, 14.75, 10, 4, 60, TRUE),
(4043, 3043, 14.40, 12, 3, 60, TRUE),
(4044, 3044, 14.40, 12, 3, 60, TRUE),
(4045, 3045,  10.00, 12, 1, 90, TRUE),

-- Aula 42
(4046, 3046, 22.60, 10, 4, 60, TRUE),
(4047, 3047, 14.40, 12, 3, 60, TRUE),
(4048, 3048, 14.40, 12, 3, 60, TRUE),
(4049, 3049, 10.00, 12, 1, 60, TRUE),

-- Aula 43
(4050, 3050, 25.00, 10, 4, 60, TRUE),
(4051, 3051, 8.45, 12, 3, 60, TRUE),
(4052, 3052, 15.60, 12, 3, 60, TRUE),
(4053, 3053,  7.56, 12, 1, 90, TRUE),

-- Aula 44
(3054, 3054, 25.75, 10, 4, 60, TRUE),
(3055, 3055, 23.46, 12, 3, 60, TRUE),
(3056, 3056, 15.60, 12, 3, 60, TRUE),
(3057, 3057,  7.57, 12, 1, 90, TRUE),

-- Aula 45
(4058, 3058, 27.00, 10, 4, 60, TRUE),
(4059, 3059, 23.47, 12, 3, 60, TRUE),
(4060, 3060, 15.60, 12, 3, 60, TRUE),
(4061, 3061,  7.58, 12, 1, 90, TRUE),

-- Aula 46
(4062, 3062, 27.50, 10, 4, 60, TRUE),
(4063, 3063, 25.20, 12, 3, 60, TRUE),
(4064, 3064, 17.50, 12, 3, 60, TRUE),
(4065, 3065,  7.59, 12, 1, 90, TRUE),

-- Aula 47
(4066, 3066, 8.49, 10, 4, 60, TRUE),
(4067, 3067, 25.20, 12, 3, 60, TRUE),
(4068, 3068, 17.50, 12, 3, 60, TRUE),
(4069, 3069,  7.60, 30, 1, 90, TRUE),
(4070, 3070, 10.35, 10, 4, 60, TRUE),

-- Aula 48
(4071, 3071, 17.50, 12, 3, 60, TRUE),
(4072, 3072, 17.50, 12, 3, 60, TRUE),
(4073, 3073,  7.60, 30, 1, 90, TRUE),
(4074, 3074, 10.00, 10, 4, 60, TRUE),
(4075, 3075, 10.77, 12, 3, 60, TRUE),

-- Aula 49
(4076, 3076, 30.00, 12, 3, 60, TRUE),
(4077, 3077,  7.61, 30, 1, 90, TRUE),
(4078, 3078, 10.00, 10, 4, 60, TRUE),
(4079, 3079, 27.50, 12, 3, 60, TRUE),
(4080, 3080, 18.00, 12, 3, 60, TRUE),

-- Aula 50
(4081, 3081, 31.62, 30, 1, 90, TRUE),
(4082, 3082, 80.00, 10, 4, 60, TRUE),
(4083, 3083, 28.80, 12, 3, 60, TRUE),
(4084, 3084, 19.20, 12, 3, 60, TRUE),
(4085, 3085,  7.63, 30, 1, 90, TRUE),
(4086, 3086, 80.00, 10, 4, 60, TRUE),

-- Aula 51
(4087, 3087, 32.80, 12, 3, 60, TRUE),
(4088, 3088, 19.20, 12, 3, 60, TRUE),
(4089, 3089,  7.64, 30, 1, 90, TRUE),
(4090, 3090, 85.00, 10, 4, 60, TRUE),

-- Aula 52
(4091, 3091, 33.60, 12, 3, 60, TRUE),
(4092, 3092, 20.40, 12, 3, 60, TRUE),
(4093, 3093,  7.65, 30, 1, 90, TRUE),
(4094, 3094, 85.00, 10, 4, 60, TRUE),

-- Aula 53
(4095, 3095, 36.60, 12, 3, 60, TRUE),
(4096, 3096, 20.40, 12, 3, 60, TRUE),
(4097, 3097,  7.66, 30, 1, 90, TRUE),
(4098, 3098, 90.00, 10, 4, 60, TRUE),

-- Aula 54
(4099, 3099, 38.40, 12, 3, 60, TRUE),
(4100, 3100, 21.60, 12, 3, 60, TRUE),
(4101, 3101,  7.67, 30, 1, 90, TRUE),
(4102, 3102, 90.00, 10, 4, 60, TRUE);

-- ========================================
-- TABELA: feedbacks (SUELLEN e Alex - Outubro)
-- ========================================
INSERT INTO vitalis.feedbacks 
(aulas_id, pessoas_id, descricao, data_criacao, tipo_autor, intensidade) VALUES

-- SUELLEN (aluna id/pessoa 6) - Semana 1
(9, 6, 'Me senti bem mais confiante nos exercícios de hoje.', '2025-11-01 09:10:00', 'ALUNO', 'MODERADO'),
(9, 5, 'SUELLEN executou todos os exercícios com boa técnica.', '2025-11-01 09:15:00', 'PERSONAL', 'LEVE'),
(10, 6, 'Um pouco cansada, mas percebi melhora no condicionamento.', '2025-11-03 09:10:00', 'ALUNO', 'LEVE'),

-- SUELLEN - Semana 1 (continuação)
...
(19, 5, 'Ótima entrega da SUELLEN; próxima fase será focada em manutenção.', '2025-11-19 09:20:00', 'PERSONAL', 'LEVE'),

-- SUELLEN - Aula 20 (semana 4 já realizada)
