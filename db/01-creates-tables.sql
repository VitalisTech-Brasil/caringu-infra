...
CREATE TABLE IF NOT EXISTS `vitalis`.`pessoas` (
  ...
  `google_id` TEXT NULL,
  `perfil_completo` BOOLEAN NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `vitalis`.`notificacoes` (
  ...
  `tipo` ENUM('FEEDBACK_TREINO', 'PAGAMENTO_REALIZADO', 'PLANO_PROXIMO_VENCIMENTO', 'NOVA_FOTO_PROGRESSO', 'TREINO_PROXIMO_VENCIMENTO', 'PAGAMENTO_CANCELADO', 'AULAS_PENDENTES') NOT NULL,
